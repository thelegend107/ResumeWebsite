...
CREATE TABLE SubRegion (
	...
	RegionId INT CONSTRAINT fk_Region_SubRegion FOREIGN KEY REFERENCES Region(Id) ON DELETE CASCADE ON UPDATE CASCADE,
	Name NVARCHAR(50) NOT NULL
);
GO
...
CREATE TABLE Country (
	...
	RegionId INT NULL CONSTRAINT fk_Region_Country FOREIGN KEY REFERENCES Region(Id),
	SubRegionId INT NULL CONSTRAINT fk_SubRegion_Country FOREIGN KEY REFERENCES SubRegion(Id) ON DELETE CASCADE ON UPDATE CASCADE,
	Name NVARCHAR(50) NOT NULL,
...
CREATE TABLE State (
	...
	CountryId INT NOT NULL CONSTRAINT fk_Country_State FOREIGN KEY REFERENCES Country(Id) ON DELETE CASCADE ON UPDATE CASCADE,
